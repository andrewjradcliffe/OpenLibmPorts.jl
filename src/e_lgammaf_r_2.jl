tofloat32(x::UInt32) = reinterpret(Float32, x)
# In order of appearance
tofloat32(0x7f800000) # Inf32
tofloat32(0x35000000) # 4.7683716f-7
tofloat32(0x4b000000) # 8.388608f6
tofloat32(0x3f800000) # 1.0f0
tofloat32(0x40000000) # 2.0f0
tofloat32(0x3f666666) # 0.9f0
tofloat32(0x3f3b4a20) # 0.7315998f0
tofloat32(0x3e6d3308) # 0.23163998f0
tofloat32(0x3fdda618) # 1.7316313f0
tofloat32(0x3f9da620) # 1.2316322f0
tofloat32(0x41000000) # 8.0f0
tofloat32(0x5c800000) # 2.8823038f17

# problem x range: [0.7316f0, 0.9999f0], [1.7315999f0, 1.9999f0]
x = 0.7316f0
